...
describe('consumeOptimistic', () => {
    it('should work with a single async workflow', async () => {
    ...
    it('should work with multiple async workflows', async () => {
    ...
    it('should work with multiple yields after async return', async () => {
    ...
    it('should work with multiple async stage', async () => {
        let state = initialize(0);
        let callCount = 0;
        const snapshots = [
            [false, 1],
